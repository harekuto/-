...
public final class CaseLayout {
    ...
    public static final int CARD_W = 84;
    ...
    public static Rect prevButton() { return new Rect(14, 162, 56, 18); }
    public static Rect categoryButton() { return new Rect(136, 162, 112, 18); }
    public static Rect nextButton() { return new Rect(314, 162, 56, 18); }
    public static Rect selectedPanel() { return new Rect(14, 183, 264, 18); }
    public static Rect openButton() { return new Rect(282, 183, 88, 18); }
